...
import { processTopNAnalysis } from './src/lib/analyzers/topNProcessor';
import { TopNAnalysisParams } from './src/lib/analyzers/topNTypes';
...
// Test parameters
const testParams: TopNAnalysisParams = {
  valueColumn: 'value',
